...
$data['query3']=$this->cakedetails_model->suggestions($cakeid);
$data['query2'] = $this->cakedetails_model->cakeshaperetrieve();
foreach($data['query3'] as $row)
{
$pid=$row->p_id;
$data['query4']=$this->cakedetails_model->cakesaleretrieve($pid);
}
...
$this->load->view('shoppingcart_view.php',$data);
}
...
$selectedmessage=htmlentities($this->input->post('cakemessage'),ENT_QUOTES);
$selectedquantity=$this->input->post('quantity');
$selectedprice=$this->input->post('price');
...
$this->form_validation->set_rules('dynamic_cakesize', 'Cake Size', 'required');
$this->form_validation->set_rules('SelectFlavour', 'Cake Flavour', 'required');
$cakemessage=htmlentities($this->input->post('cakemessage'),ENT_QUOTES);
...
$data['query3']=$this->cakedetails_model->suggestions($cakeid);
$this->load->model('pc_model');
$data['query6'] = $this->pc_model->productcategory();
...
{
$custfname=htmlentities($this->input->post('firstname'),ENT_QUOTES);
$custlname=htmlentities($this->input->post('lastname'),ENT_QUOTES);
$contactnew=htmlentities($this->input->post('customercontact'),ENT_QUOTES);
$emailnew=htmlentities($this->input->post('customeremail'),ENT_QUOTES);
$ss=htmlentities($this->input->post('shippingstreet'),ENT_QUOTES);
$sc=htmlentities($this->input->post('shippingcity'),ENT_QUOTES);
$sstate=htmlentities($this->input->post('shippingstate'),ENT_QUOTES);
$szip=htmlentities($this->input->post('shippingzip'),ENT_QUOTES);
$bs=htmlentities($this->input->post('billingstreet'),ENT_QUOTES);
$bc=htmlentities($this->input->post('billingcity'),ENT_QUOTES);
$bstate=htmlentities($this->input->post('billingstate'),ENT_QUOTES);
$bzip=htmlentities($this->input->post('billingzip'),ENT_QUOTES);
$ccfirstnamenew=htmlentities($this->input->post('ccfirstname'),ENT_QUOTES);
$cclastnamenew=htmlentities($this->input->post('cclastname'),ENT_QUOTES);
$ccnumbernew=htmlentities($this->input->post('ccnumber'),ENT_QUOTES);
$cvvnew=htmlentities($this->input->post('cvv'),ENT_QUOTES);
$expirymonthnew=htmlentities($this->input->post('validmonth'),ENT_QUOTES);
$expiryyearnew=htmlentities($this->input->post('validyear'),ENT_QUOTES);
$_SESSION['emailid']=htmlentities($this->input->post('customeremail'),ENT_QUOTES);
...
$this->load->model('pc_model');
$data['query8'] = $this->pc_model->productcategory();
$this->load->view('orderconfirm.php',$data);
...
{
$this->load->model('cakedetails_model');
$this->cakedetails_model->empty_cart();
$this->load->model('pc_model');
$data['query8'] = $this->pc_model->productcategory();
$this->load->view('shoppingcart_view',$data);
