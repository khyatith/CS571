...
<td><a href="<?php echo base_url() ?>index.php/onloaddashboard/display_profile/<?php echo $custusername;?>"><input type="button" style="background-color:#cc0000" id="continue" value="VIEW/EDIT PROFILE"></td>
</a>
</tr>
</table>
</form>
